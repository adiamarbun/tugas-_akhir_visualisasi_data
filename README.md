...
1. Clone repository ini ke komputer lokal Anda menggunakan perintah berikut:
   ...
   ```shell
   git clone https://github.com/adiamarbun/tugas_akhir_visualisasi_data
   ```
...
1. Masuk ke direktori proyek (Local):
    ...
    ```
    Atau bisa dengan kunjungi website ini [Project Data Analytics](https://github.com/adiamarbun/tugas-_akhir_visualisasi_data/tree/main)
